export declare const StyledButtonGroupButton: import("@stitches/react").StitchesComponentWithAutoCompleteForJSXElements<"button", {}, import("@stitches/core").TMedias & {
    initial: "";
}, {
    colors: {
        elevation1: string;
