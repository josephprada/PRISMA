...
var vectorPlugin = require('./vector-plugin-e916751d.cjs.prod.js');
var v8n = require('v8n');
...
const normalize$2 = (_ref) => {
  let {
    joystick = true
      ...
      input = vectorPlugin._objectWithoutProperties(_ref, ["joystick"]);
...
const sanitize = (value, {
  ...
  const {
    min,
    max
  } = vectorPlugin._objectSpread2(vectorPlugin._objectSpread2({}, _newValue), value);
...
function IntervalSlider(_ref) {
  let {
    ...
    onDrag
      ...
      settings = vectorPlugin._objectWithoutProperties(_ref, ["value", "bounds", "onDrag"]);
        ...
        if (!!input) {
          const {
            ...
            value
                ...
                rest = vectorPlugin._objectWithoutProperties(newInputData, ["type", "value"]);
        ...
        if (normalizedInput) {
          ...
          const {
            ...
            onEditEnd
                ...
                _options = vectorPlugin._objectWithoutProperties(options, ["onChange", "transient", "onEditStart", "onEditEnd"]);
...
function ControlInput(_ref) {
  let {
    ...
    disabled
      ...
      rest = vectorPlugin._objectWithoutProperties(_ref, ["type", "label", "path", "valueKey", "value", "settings", "setValue", "disabled"]);
...
const Control = React__default['default'].memo(({
  ...
  const {
    ...
    key
        ...
        inputProps = vectorPlugin._objectWithoutProperties(input, ["type", "label", "key"]);
...
function LevaRoot(_ref) {
  let {
    ...
    collapsed = false
      ...
      props = vectorPlugin._objectWithoutProperties(_ref, ["store", "hidden", "theme", "collapsed"]);
...
function Leva(_ref) {
  let {
    isRoot = false
      ...
      props = vectorPlugin._objectWithoutProperties(_ref, ["isRoot"]);
...
function LevaPanel(_ref) {
  let {
    store
      ...
      props = vectorPlugin._objectWithoutProperties(_ref, ["store"]);
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  React.useEffect(() => {
    ...
    Object.entries(onChangePaths).forEach(([path, onChange]) => {
      ...
      const unsub = store.useStore.subscribe(([value, input]) => onChange(value, path, vectorPlugin._objectSpread2({
        initial: false,
        get: store.get
      }, input)), s => {
